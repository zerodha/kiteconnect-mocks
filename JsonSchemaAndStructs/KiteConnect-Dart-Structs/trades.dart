...
//
//     final trades = tradesFromJson(jsonString);

import 'dart:convert';

Trades tradesFromJson(String str) => Trades.fromJson(json.decode(str));

String tradesToJson(Trades data) => json.encode(data.toJson());
...
class Definitions {
    ...
    factory Definitions.fromJson(Map<String, dynamic> json) => Definitions(
        ...
        trades: TradesClass.fromJson(json["Trades"]),
    );
...
class TradesClass {
    ...
    factory TradesClass.fromJson(Map<String, dynamic> json) => TradesClass(
        additionalProperties: json["additionalProperties"],
        properties: TradesProperties.fromJson(json["properties"]),
        required: List<String>.from(json["required"].map((x) => x)),
        title: json["title"],
        type: json["type"],
    );
...
class TradesProperties {
    ...
    factory TradesProperties.fromJson(Map<String, dynamic> json) => TradesProperties(
