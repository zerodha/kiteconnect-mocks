// To parse this data:
//
//   import { Convert, BasketMargins } from "./file";
//
...
export interface BasketMargins {
    $ref:        string;
    $schema:     string;
...
export interface Definitions {
    BasketMargins: BasketMarginsClass;
    Data:          DataClass;
    Final:         Final;
    Pnl:           Pnl;
}

export interface BasketMarginsClass {
...
export interface BasketMarginsProperties {
    data:   Data;
    status: Status;
}
...
export class Convert {
    public static toBasketMargins(json: string): BasketMargins {
        return cast(JSON.parse(json), r("BasketMargins"));
    }

    public static basketMarginsToJson(value: BasketMargins): string {
