// To parse this data:
//
//   import { Convert, OrderMargins } from "./file";
//
...
export interface Definitions {
    Datum:        Datum;
    OrderMargins: OrderMarginsClass;
    Pnl:          PnlClass;
}
...
export interface OrderMarginsClass {
    additionalProperties: boolean;
...
export interface OrderMarginsProperties {
    data:   Data;
    status: Additional;
}
...
export interface PnlProperties {
    realised:   Additional;
...
export class Convert {
    public static toOrderMargins(json: string): OrderMargins {
        return cast(JSON.parse(json), r("OrderMargins"));
    }

    public static orderMarginsToJson(value: OrderMargins): string {
