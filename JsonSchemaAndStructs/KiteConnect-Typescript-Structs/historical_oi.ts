// To parse this data:
//
//   import { Convert, HistoricalOi } from "./file";
//
//   const historicalOi = Convert.toHistoricalOi(json);
//
...
export class Convert {
    public static toHistoricalOi(json: string): HistoricalOi {
        return cast(JSON.parse(json), r("HistoricalOi"));
    }

    public static historicalOiToJson(value: HistoricalOi): string {
        return JSON.stringify(uncast(value, r("HistoricalOi")), null, 2);
    }
}
