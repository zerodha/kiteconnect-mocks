...
export interface OhlcClassClass {
    additionalProperties: boolean;
...
export interface OhlcClassProperties {
...
export class Convert {
    public static toOhlc(json: string): Ohlc {
        return cast(JSON.parse(json), r("Ohlc"));
    }

    public static ohlcToJson(value: Ohlc): string {
