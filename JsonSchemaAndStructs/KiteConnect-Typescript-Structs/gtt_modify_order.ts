// To parse this data:
//
//   import { Convert, GttModifyOrder } from "./file";
//
//   const gttModifyOrder = Convert.toGttModifyOrder(json);
//
...
export class Convert {
    public static toGttModifyOrder(json: string): GttModifyOrder {
        return cast(JSON.parse(json), r("GttModifyOrder"));
    }

    public static gttModifyOrderToJson(value: GttModifyOrder): string {
        return JSON.stringify(uncast(value, r("GttModifyOrder")), null, 2);
    }
}
