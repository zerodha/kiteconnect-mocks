// To parse this data:
//
//   import { Convert, MFOrders } from "./file";
//
...
export interface MFOrdersClass {
    additionalProperties: boolean;
...
export interface MFOrdersProperties {
    data:   Data;
    status: Amount;
}
...
export class Convert {
    public static toMFOrders(json: string): MFOrders {
        return cast(JSON.parse(json), r("MFOrders"));
    }

    public static mFOrdersToJson(value: MFOrders): string {
...
const typeMap: any = {
    ...
    "Definitions": o([
        ...
        { json: "MFOrders", js: "MFOrders", typ: r("MFOrdersClass") },
    ], false),
    "Datum": o([
    ...
    "DatumProperties": o([
        ...
        { json: "exchange_timestamp", js: "exchange_timestamp", typ: r("ExchangeOrderID") },
        ...
        { json: "settlement_id", js: "settlement_id", typ: r("ExchangeOrderID") },
    ...
    "ExchangeOrderID": o([
        { json: "anyOf", js: "anyOf", typ: a(r("LastPriceDate")) },
    ], false),
    "LastPriceDate": o([
    ...
    "Tag": o([
        { json: "anyOf", js: "anyOf", typ: a(r("Amount")) },
    ], false),
    "MFOrdersClass": o([
        { json: "additionalProperties", js: "additionalProperties", typ: true },
        { json: "properties", js: "properties", typ: r("MFOrdersProperties") },
        { json: "required", js: "required", typ: a("") },
        { json: "title", js: "title", typ: "" },
        { json: "type", js: "type", typ: "" },
    ], false),
    "MFOrdersProperties": o([
