// To parse this data:
//
//   import { Convert, HistoricalMinute } from "./file";
//
//   const historicalMinute = Convert.toHistoricalMinute(json);
//
...
export interface Definitions {
    Candle:           Candle;
    Data:             Data;
    HistoricalMinute: HistoricalMinuteClass;
}
...
export interface HistoricalMinuteClass {
    additionalProperties: boolean;
...
export interface HistoricalMinuteProperties {
    data:   DataClass;
    status: AnyOf;
}
...
export class Convert {
    public static toHistoricalMinute(json: string): HistoricalMinute {
        return cast(JSON.parse(json), r("HistoricalMinute"));
    }

    public static historicalMinuteToJson(value: HistoricalMinute): string {
        return JSON.stringify(uncast(value, r("HistoricalMinute")), null, 2);
    }
}
