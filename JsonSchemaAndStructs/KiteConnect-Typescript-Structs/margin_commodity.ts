// To parse this data:
//
//   import { Convert, MarginCommodity } from "./file";
//
//   const marginCommodity = Convert.toMarginCommodity(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface MarginCommodity {
    $ref:        string;
    $schema:     string;
...
export interface Definitions {
    Available:       Available;
    Data:            Data;
    MarginCommodity: MarginCommodityClass;
}
...
export interface MarginCommodityClass {
    additionalProperties: boolean;
...
export interface MarginCommodityProperties {
    data:   AvailableClass;
    status: AdhocMargin;
}
...
export class Convert {
    public static toMarginCommodity(json: string): MarginCommodity {
        return cast(JSON.parse(json), r("MarginCommodity"));
    }

    public static marginCommodityToJson(value: MarginCommodity): string {
        return JSON.stringify(uncast(value, r("MarginCommodity")), null, 2);
    }
}
