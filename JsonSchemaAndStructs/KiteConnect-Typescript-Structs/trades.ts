// To parse this data:
//
//   import { Convert, Trades } from "./file";
//
...
export interface TradesProperties {
    data:   Data;
    status: AveragePrice;
}
...
export class Convert {
    public static toTrades(json: string): Trades {
        return cast(JSON.parse(json), r("Trades"));
    }

    public static tradesToJson(value: Trades): string {
...
const typeMap: any = {
    ...
    "Definitions": o([
        ...
        { json: "Trades", js: "Trades", typ: r("TradesClass") },
    ], false),
    "Datum": o([
    ...
    "TradesClass": o([
        { json: "additionalProperties", js: "additionalProperties", typ: true },
        { json: "properties", js: "properties", typ: r("TradesProperties") },
        { json: "required", js: "required", typ: a("") },
        { json: "title", js: "title", typ: "" },
        { json: "type", js: "type", typ: "" },
    ], false),
