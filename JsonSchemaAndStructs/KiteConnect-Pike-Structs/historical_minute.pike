...
HistoricalMinute HistoricalMinute_from_JSON(mixed json) {
    HistoricalMinute retval = HistoricalMinute();
...
class Definitions {
    ...
    Data                  data;              // json: "Data"
    HistoricalMinuteClass historical_minute; // json: "HistoricalMinute"

    string encode_json() {
        mapping(string:mixed) json = ([
            "Candle" : candle,
            "Data" : data,
            "HistoricalMinute" : historical_minute,
        ]);
...
Definitions Definitions_from_JSON(mixed json) {
    ...
    retval.historical_minute = json["HistoricalMinute"];
...
class HistoricalMinuteClass {
    bool                       additional_properties; // json: "additionalProperties"
    HistoricalMinuteProperties properties;            // json: "properties"
    array(string)              required;              // json: "required"
    string                     title;                 // json: "title"
    string                     type;                  // json: "type"
...
HistoricalMinuteClass HistoricalMinuteClass_from_JSON(mixed json) {
    HistoricalMinuteClass retval = HistoricalMinuteClass();
...
HistoricalMinuteProperties HistoricalMinuteProperties_from_JSON(mixed json) {
    HistoricalMinuteProperties retval = HistoricalMinuteProperties();
