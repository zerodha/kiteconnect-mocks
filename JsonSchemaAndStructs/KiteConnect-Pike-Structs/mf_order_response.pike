...
class Definitions {
    Data                 data;              // json: "Data"
    MfOrderResponseClass mf_order_response; // json: "MFOrderResponse"

    string encode_json() {
        mapping(string:mixed) json = ([
            "Data" : data,
            "MFOrderResponse" : mf_order_response,
        ]);
...
Definitions Definitions_from_JSON(mixed json) {
    ...
    retval.mf_order_response = json["MFOrderResponse"];
...
class MfOrderResponseClass {
    bool                      additional_properties; // json: "additionalProperties"
    MfOrderResponseProperties properties;            // json: "properties"
    array(string)             required;              // json: "required"
    string                    title;                 // json: "title"
    string                    type;                  // json: "type"
...
MfOrderResponseClass MfOrderResponseClass_from_JSON(mixed json) {
    MfOrderResponseClass retval = MfOrderResponseClass();
...
MfOrderResponseProperties MfOrderResponseProperties_from_JSON(mixed json) {
    MfOrderResponseProperties retval = MfOrderResponseProperties();
