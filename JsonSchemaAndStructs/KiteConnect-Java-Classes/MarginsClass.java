...
public class MarginsClass {
    private boolean additionalProperties;
    private MarginsProperties properties;
    ...
    public MarginsProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MarginsProperties value) { this.properties = value; }
