...
public class MFSIPInfoClass {
    private boolean additionalProperties;
    private MFSIPInfoProperties properties;
    ...
    public MFSIPInfoProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MFSIPInfoProperties value) { this.properties = value; }
