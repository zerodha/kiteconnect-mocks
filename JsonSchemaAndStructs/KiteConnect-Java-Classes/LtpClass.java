...
public class LtpClass {
    private boolean additionalProperties;
    private LtpProperties properties;
    ...
    public LtpProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(LtpProperties value) { this.properties = value; }
