...
public class MFOrdersClass {
    private boolean additionalProperties;
    private MFOrdersProperties properties;
    ...
    public MFOrdersProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MFOrdersProperties value) { this.properties = value; }
