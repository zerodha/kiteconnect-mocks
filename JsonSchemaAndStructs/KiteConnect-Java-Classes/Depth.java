...
public class Depth {
    ...
    private DepthProperties properties;
    ...
    public DepthProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(DepthProperties value) { this.properties = value; }
