...
public class MFSipsClass {
    private boolean additionalProperties;
    private MFSipsProperties properties;
    ...
    public MFSipsProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MFSipsProperties value) { this.properties = value; }
