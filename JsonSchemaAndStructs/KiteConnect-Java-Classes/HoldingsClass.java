...
public class HoldingsClass {
    private boolean additionalProperties;
    private HoldingsProperties properties;
    ...
    public HoldingsProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(HoldingsProperties value) { this.properties = value; }
