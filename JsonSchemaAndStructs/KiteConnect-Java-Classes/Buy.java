...
public class Buy {
    ...
    private BuyProperties properties;
    ...
    public BuyProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(BuyProperties value) { this.properties = value; }
