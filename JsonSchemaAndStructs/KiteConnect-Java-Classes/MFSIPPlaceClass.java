...
public class MFSIPPlaceClass {
    private boolean additionalProperties;
    private MFSIPPlaceProperties properties;
    ...
    public MFSIPPlaceProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MFSIPPlaceProperties value) { this.properties = value; }
