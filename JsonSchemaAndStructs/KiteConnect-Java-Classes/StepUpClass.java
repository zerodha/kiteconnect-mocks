...
public class StepUpClass {
    private boolean additionalProperties;
    private StepUpProperties properties;
    ...
    public StepUpProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(StepUpProperties value) { this.properties = value; }
