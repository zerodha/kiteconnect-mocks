...
public class Ohlc {
    ...
    private OhlcProperties properties;
    ...
    public OhlcProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(OhlcProperties value) { this.properties = value; }
