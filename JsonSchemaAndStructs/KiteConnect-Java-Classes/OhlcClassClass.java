...
public class OhlcClassClass {
    private boolean additionalProperties;
    private OhlcClassProperties properties;
    ...
    public OhlcClassProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(OhlcClassProperties value) { this.properties = value; }
