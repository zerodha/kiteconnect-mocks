...
public class OrderInfoClass {
    ...
    private OrderInfoProperties properties;
    ...
    public OrderInfoProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(OrderInfoProperties value) { this.properties = value; }
