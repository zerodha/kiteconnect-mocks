...
public class PnlClass {
    ...
    private PnlProperties properties;
    ...
    public PnlProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(PnlProperties value) { this.properties = value; }
