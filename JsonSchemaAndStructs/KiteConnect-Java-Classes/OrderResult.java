...
public class OrderResult {
    ...
    private OrderResultProperties properties;
    ...
    public OrderResultProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(OrderResultProperties value) { this.properties = value; }
