...
public class Datum {
    ...
    private DatumProperties properties;
    ...
    public DatumProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(DatumProperties value) { this.properties = value; }
