...
public class MFHoldingsClass {
    private boolean additionalProperties;
    private MFHoldingsProperties properties;
    ...
    public MFHoldingsProperties getProperties() { return properties; }
    @JsonProperty("properties")
    public void setProperties(MFHoldingsProperties value) { this.properties = value; }
