...
//
//     OrderModify data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
    ...
    class OrderModifyProperties {
        public:
        OrderModifyProperties() = default;
        virtual ~OrderModifyProperties() = default;
    ...
    class OrderModifyClass {
        public:
        OrderModifyClass() = default;
        virtual ~OrderModifyClass() = default;
        ...
        const OrderModifyProperties & get_properties() const { return properties; }
        OrderModifyProperties & get_mutable_properties() { return properties; }
        void set_properties(const OrderModifyProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        const OrderModifyClass & get_order_modify() const { return order_modify; }
        OrderModifyClass & get_mutable_order_modify() { return order_modify; }
        void set_order_modify(const OrderModifyClass & value) { this->order_modify = value; }
    };

    class OrderModify {
        public:
        OrderModify() = default;
        virtual ~OrderModify() = default;
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::OrderModifyProperties & x);
    void to_json(json & j, const quicktype::OrderModifyProperties & x);

    void from_json(const json & j, quicktype::OrderModifyClass & x);
    void to_json(json & j, const quicktype::OrderModifyClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::OrderModify & x);
    void to_json(json & j, const quicktype::OrderModify & x);
    ...
    inline void from_json(const json & j, quicktype::OrderModifyProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::OrderId>());
    }

    inline void to_json(json & j, const quicktype::OrderModifyProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::OrderModifyClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::OrderModifyProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::OrderModifyClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_order_modify(j.at("OrderModify").get<quicktype::OrderModifyClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Data"] = x.get_data();
        j["OrderModify"] = x.get_order_modify();
    }

    inline void from_json(const json & j, quicktype::OrderModify& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::OrderModify & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
