...
//
//     OrderCancel data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
    ...
    class OrderCancelProperties {
        public:
        OrderCancelProperties() = default;
        virtual ~OrderCancelProperties() = default;
    ...
    class OrderCancelClass {
        public:
        OrderCancelClass() = default;
        virtual ~OrderCancelClass() = default;
        ...
        const OrderCancelProperties & get_properties() const { return properties; }
        OrderCancelProperties & get_mutable_properties() { return properties; }
        void set_properties(const OrderCancelProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        const OrderCancelClass & get_order_cancel() const { return order_cancel; }
        OrderCancelClass & get_mutable_order_cancel() { return order_cancel; }
        void set_order_cancel(const OrderCancelClass & value) { this->order_cancel = value; }
    };

    class OrderCancel {
        public:
        OrderCancel() = default;
        virtual ~OrderCancel() = default;
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::OrderCancelProperties & x);
    void to_json(json & j, const quicktype::OrderCancelProperties & x);

    void from_json(const json & j, quicktype::OrderCancelClass & x);
    void to_json(json & j, const quicktype::OrderCancelClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::OrderCancel & x);
    void to_json(json & j, const quicktype::OrderCancel & x);
    ...
    inline void from_json(const json & j, quicktype::OrderCancelProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::OrderId>());
    }

    inline void to_json(json & j, const quicktype::OrderCancelProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::OrderCancelClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::OrderCancelProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::OrderCancelClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_order_cancel(j.at("OrderCancel").get<quicktype::OrderCancelClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Data"] = x.get_data();
        j["OrderCancel"] = x.get_order_cancel();
    }

    inline void from_json(const json & j, quicktype::OrderCancel& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::OrderCancel & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
