...
namespace nlohmann {
    void from_json(const json & j, MarginCommodity::Available & x);
    void to_json(json & j, const MarginCommodity::Available & x);

    void from_json(const json & j, MarginCommodity::Data & x);
    void to_json(json & j, const MarginCommodity::Data & x);

    void from_json(const json & j, MarginCommodity::MarginCommodity & x);
    void to_json(json & j, const MarginCommodity::MarginCommodity & x);

    inline void from_json(const json & j, MarginCommodity::Available& x) {
        x.set_adhoc_margin(MarginCommodity::get_optional<int64_t>(j, "adhoc_margin"));
        x.set_cash(MarginCommodity::get_optional<double>(j, "cash"));
        x.set_collateral(MarginCommodity::get_optional<int64_t>(j, "collateral"));
        x.set_intraday_payin(MarginCommodity::get_optional<int64_t>(j, "intraday_payin"));
        x.set_live_balance(MarginCommodity::get_optional<double>(j, "live_balance"));
        x.set_opening_balance(MarginCommodity::get_optional<double>(j, "opening_balance"));
    }

    inline void to_json(json & j, const MarginCommodity::Available & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, MarginCommodity::Data& x) {
        x.set_available(MarginCommodity::get_optional<MarginCommodity::Available>(j, "available"));
        x.set_enabled(MarginCommodity::get_optional<bool>(j, "enabled"));
        x.set_net(MarginCommodity::get_optional<double>(j, "net"));
        x.set_utilised(MarginCommodity::get_optional<std::map<std::string, double>>(j, "utilised"));
    }

    inline void to_json(json & j, const MarginCommodity::Data & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, MarginCommodity::MarginCommodity& x) {
        x.set_data(MarginCommodity::get_optional<MarginCommodity::Data>(j, "data"));
        x.set_status(MarginCommodity::get_optional<std::string>(j, "status"));
    }

    inline void to_json(json & j, const MarginCommodity::MarginCommodity & x) {
        j = json::object();
        j["data"] = x.get_data();
