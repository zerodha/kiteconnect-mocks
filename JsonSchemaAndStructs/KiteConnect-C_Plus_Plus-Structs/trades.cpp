...
namespace quicktype {
    ...
    class TradesProperties {
        public:
        TradesProperties() = default;
        virtual ~TradesProperties() = default;
    ...
    class TradesClass {
        public:
        TradesClass() = default;
        virtual ~TradesClass() = default;

        private:
        bool additional_properties;
        TradesProperties properties;
        std::vector<std::string> required;
        std::string title;
        std::string type;
        ...
        const TradesProperties & get_properties() const { return properties; }
        TradesProperties & get_mutable_properties() { return properties; }
        void set_properties(const TradesProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        const TradesClass & get_trades() const { return trades; }
        TradesClass & get_mutable_trades() { return trades; }
        void set_trades(const TradesClass & value) { this->trades = value; }
    };
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::TradesProperties & x);
    void to_json(json & j, const quicktype::TradesProperties & x);

    void from_json(const json & j, quicktype::TradesClass & x);
    void to_json(json & j, const quicktype::TradesClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::Trades & x);
    void to_json(json & j, const quicktype::Trades & x);
    ...
    inline void from_json(const json & j, quicktype::TradesProperties& x) {
        x.set_data(j.at("data").get<quicktype::Data>());
        x.set_status(j.at("status").get<quicktype::AveragePrice>());
    }

    inline void to_json(json & j, const quicktype::TradesProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::TradesClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::TradesProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::TradesClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_trades(j.at("Trades").get<quicktype::TradesClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Datum"] = x.get_datum();
        j["Trades"] = x.get_trades();
    }

    inline void from_json(const json & j, quicktype::Trades& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::Trades & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
