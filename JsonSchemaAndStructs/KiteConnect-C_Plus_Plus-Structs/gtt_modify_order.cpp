...
//
//     GttModifyOrder data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
    ...
    class GttModifyOrderProperties {
        public:
        GttModifyOrderProperties() = default;
        virtual ~GttModifyOrderProperties() = default;
    ...
    class GttModifyOrderClass {
        public:
        GttModifyOrderClass() = default;
        virtual ~GttModifyOrderClass() = default;
        ...
        const GttModifyOrderProperties & get_properties() const { return properties; }
        GttModifyOrderProperties & get_mutable_properties() { return properties; }
        void set_properties(const GttModifyOrderProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        private:
        Data data;
        GttModifyOrderClass gtt_modify_order;
        ...
        const GttModifyOrderClass & get_gtt_modify_order() const { return gtt_modify_order; }
        GttModifyOrderClass & get_mutable_gtt_modify_order() { return gtt_modify_order; }
        void set_gtt_modify_order(const GttModifyOrderClass & value) { this->gtt_modify_order = value; }
    };

    class GttModifyOrder {
        public:
        GttModifyOrder() = default;
        virtual ~GttModifyOrder() = default;
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::GttModifyOrderProperties & x);
    void to_json(json & j, const quicktype::GttModifyOrderProperties & x);

    void from_json(const json & j, quicktype::GttModifyOrderClass & x);
    void to_json(json & j, const quicktype::GttModifyOrderClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::GttModifyOrder & x);
    void to_json(json & j, const quicktype::GttModifyOrder & x);
    ...
    inline void from_json(const json & j, quicktype::GttModifyOrderProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::TriggerId>());
    }

    inline void to_json(json & j, const quicktype::GttModifyOrderProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::GttModifyOrderClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::GttModifyOrderProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::GttModifyOrderClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_gtt_modify_order(j.at("GttModifyOrder").get<quicktype::GttModifyOrderClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Data"] = x.get_data();
        j["GttModifyOrder"] = x.get_gtt_modify_order();
    }

    inline void from_json(const json & j, quicktype::GttModifyOrder& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::GttModifyOrder & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
