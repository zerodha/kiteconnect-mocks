...
namespace quicktype {
    ...
    class GttGetOrderProperties {
        public:
        GttGetOrderProperties() = default;
        virtual ~GttGetOrderProperties() = default;
        ...
        public:
        const ConditionClass & get_data() const { return data; }
        ConditionClass & get_mutable_data() { return data; }
        void set_data(const ConditionClass & value) { this->data = value; }
    ...
    class GttGetOrderClass {
        public:
        GttGetOrderClass() = default;
        virtual ~GttGetOrderClass() = default;
        ...
        const GttGetOrderProperties & get_properties() const { return properties; }
        GttGetOrderProperties & get_mutable_properties() { return properties; }
        void set_properties(const GttGetOrderProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        Condition condition;
        Data data;
        GttGetOrderClass gtt_get_order;
        Order order;
        ...
        const GttGetOrderClass & get_gtt_get_order() const { return gtt_get_order; }
        GttGetOrderClass & get_mutable_gtt_get_order() { return gtt_get_order; }
        void set_gtt_get_order(const GttGetOrderClass & value) { this->gtt_get_order = value; }
        ...
        const ResultClass & get_result() const { return result; }
        ResultClass & get_mutable_result() { return result; }
        void set_result(const ResultClass & value) { this->result = value; }
    };
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::GttGetOrderProperties & x);
    void to_json(json & j, const quicktype::GttGetOrderProperties & x);

    void from_json(const json & j, quicktype::GttGetOrderClass & x);
    void to_json(json & j, const quicktype::GttGetOrderClass & x);
    ...
    void from_json(const json & j, quicktype::ResultClass & x);
    void to_json(json & j, const quicktype::ResultClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::GttGetOrder & x);
    void to_json(json & j, const quicktype::GttGetOrder & x);
    ...
    inline void from_json(const json & j, quicktype::GttGetOrderProperties& x) {
        x.set_data(j.at("data").get<quicktype::ConditionClass>());
        x.set_status(j.at("status").get<quicktype::Exchange>());
    }

    inline void to_json(json & j, const quicktype::GttGetOrderProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::GttGetOrderClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::GttGetOrderProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::GttGetOrderClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::ResultClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
    ...
    inline void to_json(json & j, const quicktype::ResultClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_gtt_get_order(j.at("GttGetOrder").get<quicktype::GttGetOrderClass>());
        x.set_order(j.at("Order").get<quicktype::Order>());
        x.set_order_result(j.at("OrderResult").get<quicktype::OrderResult>());
        x.set_result(j.at("Result").get<quicktype::ResultClass>());
    }
    ...
    inline void to_json(json & j, const quicktype::Definitions & x) {
        ...
        j["Condition"] = x.get_condition();
        j["Data"] = x.get_data();
        j["GttGetOrder"] = x.get_gtt_get_order();
        j["Order"] = x.get_order();
        j["OrderResult"] = x.get_order_result();
        j["Result"] = x.get_result();
    }

    inline void from_json(const json & j, quicktype::GttGetOrder& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::GttGetOrder & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
