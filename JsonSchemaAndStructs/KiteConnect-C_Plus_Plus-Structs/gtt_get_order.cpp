...
//
//     GttGetOrder data = nlohmann::json::parse(jsonString);
...
namespace GttGetOrder {
    ...
    class Data {
        ...
        const nlohmann::json & get_meta() const { return meta; }
        nlohmann::json & get_mutable_meta() { return meta; }
        void set_meta(const nlohmann::json & value) { this->meta = value; }
...
namespace nlohmann {
    void from_json(const json & j, GttGetOrder::Condition & x);
    void to_json(json & j, const GttGetOrder::Condition & x);

    void from_json(const json & j, GttGetOrder::OrderResult & x);
    void to_json(json & j, const GttGetOrder::OrderResult & x);

    void from_json(const json & j, GttGetOrder::Result & x);
    void to_json(json & j, const GttGetOrder::Result & x);

    void from_json(const json & j, GttGetOrder::Order & x);
    void to_json(json & j, const GttGetOrder::Order & x);

    void from_json(const json & j, GttGetOrder::Data & x);
    void to_json(json & j, const GttGetOrder::Data & x);

    void from_json(const json & j, GttGetOrder::GttGetOrder & x);
    void to_json(json & j, const GttGetOrder::GttGetOrder & x);

    inline void from_json(const json & j, GttGetOrder::Condition& x) {
        x.set_exchange(GttGetOrder::get_optional<std::string>(j, "exchange"));
        x.set_instrument_token(GttGetOrder::get_optional<int64_t>(j, "instrument_token"));
        x.set_last_price(GttGetOrder::get_optional<double>(j, "last_price"));
        x.set_tradingsymbol(GttGetOrder::get_optional<std::string>(j, "tradingsymbol"));
        x.set_trigger_values(GttGetOrder::get_optional<std::vector<double>>(j, "trigger_values"));
    }

    inline void to_json(json & j, const GttGetOrder::Condition & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, GttGetOrder::OrderResult& x) {
        x.set_order_id(GttGetOrder::get_optional<std::string>(j, "order_id"));
        x.set_rejection_reason(GttGetOrder::get_optional<std::string>(j, "rejection_reason"));
        x.set_status(GttGetOrder::get_optional<std::string>(j, "status"));
    }

    inline void to_json(json & j, const GttGetOrder::OrderResult & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, GttGetOrder::Result& x) {
        x.set_account_id(GttGetOrder::get_optional<std::string>(j, "account_id"));
        x.set_exchange(GttGetOrder::get_optional<std::string>(j, "exchange"));
        x.set_meta(GttGetOrder::get_optional<std::string>(j, "meta"));
        x.set_order_result(GttGetOrder::get_optional<GttGetOrder::OrderResult>(j, "order_result"));
        x.set_order_type(GttGetOrder::get_optional<std::string>(j, "order_type"));
        x.set_price(GttGetOrder::get_optional<int64_t>(j, "price"));
        x.set_product(GttGetOrder::get_optional<std::string>(j, "product"));
        x.set_quantity(GttGetOrder::get_optional<int64_t>(j, "quantity"));
        x.set_timestamp(GttGetOrder::get_optional<std::string>(j, "timestamp"));
        x.set_tradingsymbol(GttGetOrder::get_optional<std::string>(j, "tradingsymbol"));
        x.set_transaction_type(GttGetOrder::get_optional<std::string>(j, "transaction_type"));
        x.set_triggered_at(GttGetOrder::get_optional<double>(j, "triggered_at"));
        x.set_validity(GttGetOrder::get_optional<std::string>(j, "validity"));
    }

    inline void to_json(json & j, const GttGetOrder::Result & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, GttGetOrder::Order& x) {
        x.set_exchange(GttGetOrder::get_optional<std::string>(j, "exchange"));
        x.set_order_type(GttGetOrder::get_optional<std::string>(j, "order_type"));
        x.set_price(GttGetOrder::get_optional<int64_t>(j, "price"));
        x.set_product(GttGetOrder::get_optional<std::string>(j, "product"));
        x.set_quantity(GttGetOrder::get_optional<int64_t>(j, "quantity"));
        x.set_result(GttGetOrder::get_optional<GttGetOrder::Result>(j, "result"));
        x.set_tradingsymbol(GttGetOrder::get_optional<std::string>(j, "tradingsymbol"));
        x.set_transaction_type(GttGetOrder::get_optional<std::string>(j, "transaction_type"));
    }

    inline void to_json(json & j, const GttGetOrder::Order & x) {
        j = json::object();
        j["exchange"] = x.get_exchange();
        j["order_type"] = x.get_order_type();
        j["price"] = x.get_price();
    ...
    inline void from_json(const json & j, GttGetOrder::Data& x) {
        x.set_condition(GttGetOrder::get_optional<GttGetOrder::Condition>(j, "condition"));
        x.set_created_at(GttGetOrder::get_optional<std::string>(j, "created_at"));
        x.set_expires_at(GttGetOrder::get_optional<std::string>(j, "expires_at"));
        x.set_id(GttGetOrder::get_optional<int64_t>(j, "id"));
        x.set_meta(GttGetOrder::get_untyped(j, "meta"));
        x.set_orders(GttGetOrder::get_optional<std::vector<GttGetOrder::Order>>(j, "orders"));
        x.set_parent_trigger(GttGetOrder::get_untyped(j, "parent_trigger"));
        x.set_status(GttGetOrder::get_optional<std::string>(j, "status"));
        x.set_type(GttGetOrder::get_optional<std::string>(j, "type"));
        x.set_updated_at(GttGetOrder::get_optional<std::string>(j, "updated_at"));
        x.set_user_id(GttGetOrder::get_optional<std::string>(j, "user_id"));
    }

    inline void to_json(json & j, const GttGetOrder::Data & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, GttGetOrder::GttGetOrder& x) {
        x.set_data(GttGetOrder::get_optional<GttGetOrder::Data>(j, "data"));
        x.set_status(GttGetOrder::get_optional<std::string>(j, "status"));
    }

    inline void to_json(json & j, const GttGetOrder::GttGetOrder & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }
