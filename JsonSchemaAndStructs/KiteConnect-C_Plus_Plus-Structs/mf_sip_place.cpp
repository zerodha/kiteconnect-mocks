...
//
//     MfSipPlace data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
    ...
    class DataProperties {
        ...
        public:
        const Sipid & get_sip_id() const { return sip_id; }
        Sipid & get_mutable_sip_id() { return sip_id; }
        void set_sip_id(const Sipid & value) { this->sip_id = value; }
    };
    ...
    class MfsipPlaceProperties {
        public:
        MfsipPlaceProperties() = default;
        virtual ~MfsipPlaceProperties() = default;
        ...
        const Sipid & get_status() const { return status; }
        Sipid & get_mutable_status() { return status; }
        void set_status(const Sipid & value) { this->status = value; }
    };

    class MfsipPlaceClass {
        public:
        MfsipPlaceClass() = default;
        virtual ~MfsipPlaceClass() = default;
        ...
        const MfsipPlaceProperties & get_properties() const { return properties; }
        MfsipPlaceProperties & get_mutable_properties() { return properties; }
        void set_properties(const MfsipPlaceProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        const MfsipPlaceClass & get_mfsip_place() const { return mfsip_place; }
        MfsipPlaceClass & get_mutable_mfsip_place() { return mfsip_place; }
        void set_mfsip_place(const MfsipPlaceClass & value) { this->mfsip_place = value; }
    };

    class MfSipPlace {
        public:
        MfSipPlace() = default;
        virtual ~MfSipPlace() = default;
...
namespace nlohmann {
    void from_json(const json & j, quicktype::Sipid & x);
    void to_json(json & j, const quicktype::Sipid & x);
    ...
    void from_json(const json & j, quicktype::MfsipPlaceProperties & x);
    void to_json(json & j, const quicktype::MfsipPlaceProperties & x);

    void from_json(const json & j, quicktype::MfsipPlaceClass & x);
    void to_json(json & j, const quicktype::MfsipPlaceClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::MfSipPlace & x);
    void to_json(json & j, const quicktype::MfSipPlace & x);

    inline void from_json(const json & j, quicktype::Sipid& x) {
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::Sipid & x) {
        j = json::object();
        j["type"] = x.get_type();
    }

    inline void from_json(const json & j, quicktype::DataProperties& x) {
        x.set_sip_id(j.at("sip_id").get<quicktype::Sipid>());
    }
    ...
    inline void from_json(const json & j, quicktype::MfsipPlaceProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::Sipid>());
    }

    inline void to_json(json & j, const quicktype::MfsipPlaceProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::MfsipPlaceClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::MfsipPlaceProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::MfsipPlaceClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_mfsip_place(j.at("MFSIPPlace").get<quicktype::MfsipPlaceClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Data"] = x.get_data();
        j["MFSIPPlace"] = x.get_mfsip_place();
    }

    inline void from_json(const json & j, quicktype::MfSipPlace& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::MfSipPlace & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
