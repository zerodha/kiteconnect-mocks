...
namespace quicktype {
    ...
    class MfsipCancelProperties {
        public:
        MfsipCancelProperties() = default;
        virtual ~MfsipCancelProperties() = default;
    ...
    class MfsipCancelClass {
        public:
        MfsipCancelClass() = default;
        virtual ~MfsipCancelClass() = default;
        ...
        const MfsipCancelProperties & get_properties() const { return properties; }
        MfsipCancelProperties & get_mutable_properties() { return properties; }
        void set_properties(const MfsipCancelProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        const MfsipCancelClass & get_mfsip_cancel() const { return mfsip_cancel; }
        MfsipCancelClass & get_mutable_mfsip_cancel() { return mfsip_cancel; }
        void set_mfsip_cancel(const MfsipCancelClass & value) { this->mfsip_cancel = value; }
    };
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::MfsipCancelProperties & x);
    void to_json(json & j, const quicktype::MfsipCancelProperties & x);

    void from_json(const json & j, quicktype::MfsipCancelClass & x);
    void to_json(json & j, const quicktype::MfsipCancelClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::MfSipCancel & x);
    void to_json(json & j, const quicktype::MfSipCancel & x);
    ...
    inline void from_json(const json & j, quicktype::MfsipCancelProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::Sipid>());
    }

    inline void to_json(json & j, const quicktype::MfsipCancelProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::MfsipCancelClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::MfsipCancelProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::MfsipCancelClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_mfsip_cancel(j.at("MFSIPCancel").get<quicktype::MfsipCancelClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["Data"] = x.get_data();
        j["MFSIPCancel"] = x.get_mfsip_cancel();
    }

    inline void from_json(const json & j, quicktype::MfSipCancel& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::MfSipCancel & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
