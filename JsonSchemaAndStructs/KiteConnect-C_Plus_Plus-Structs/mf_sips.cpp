...
namespace MfSips {
    ...
    class Datum {
        ...
        std::shared_ptr<std::string> sip_reg_num;
        std::shared_ptr<std::string> sip_type;
        std::shared_ptr<std::string> status;
        std::shared_ptr<std::map<std::string, int64_t>> step_up;
        ...
        std::shared_ptr<std::string> get_sip_reg_num() const { return sip_reg_num; }
        void set_sip_reg_num(std::shared_ptr<std::string> value) { this->sip_reg_num = value; }
        ...
        std::shared_ptr<std::map<std::string, int64_t>> get_step_up() const { return step_up; }
        void set_step_up(std::shared_ptr<std::map<std::string, int64_t>> value) { this->step_up = value; }
...
namespace nlohmann {
    void from_json(const json & j, MfSips::Datum & x);
    void to_json(json & j, const MfSips::Datum & x);

    void from_json(const json & j, MfSips::MfSips & x);
    void to_json(json & j, const MfSips::MfSips & x);

    inline void from_json(const json & j, MfSips::Datum& x) {
        x.set_completed_instalments(MfSips::get_optional<int64_t>(j, "completed_instalments"));
        x.set_created(MfSips::get_optional<std::string>(j, "created"));
        x.set_dividend_type(MfSips::get_optional<std::string>(j, "dividend_type"));
        x.set_frequency(MfSips::get_optional<std::string>(j, "frequency"));
        x.set_fund(MfSips::get_optional<std::string>(j, "fund"));
        x.set_instalment_amount(MfSips::get_optional<int64_t>(j, "instalment_amount"));
        x.set_instalment_day(MfSips::get_optional<int64_t>(j, "instalment_day"));
        x.set_instalments(MfSips::get_optional<int64_t>(j, "instalments"));
        x.set_last_instalment(MfSips::get_optional<std::string>(j, "last_instalment"));
        x.set_next_instalment(MfSips::get_optional<std::string>(j, "next_instalment"));
        x.set_pending_instalments(MfSips::get_optional<int64_t>(j, "pending_instalments"));
        x.set_sip_id(MfSips::get_optional<std::string>(j, "sip_id"));
        x.set_sip_reg_num(MfSips::get_optional<std::string>(j, "sip_reg_num"));
        x.set_sip_type(MfSips::get_optional<std::string>(j, "sip_type"));
        x.set_status(MfSips::get_optional<std::string>(j, "status"));
        x.set_step_up(MfSips::get_optional<std::map<std::string, int64_t>>(j, "step_up"));
        x.set_tag(MfSips::get_optional<std::string>(j, "tag"));
        x.set_tradingsymbol(MfSips::get_optional<std::string>(j, "tradingsymbol"));
        x.set_transaction_type(MfSips::get_optional<std::string>(j, "transaction_type"));
        x.set_trigger_price(MfSips::get_optional<int64_t>(j, "trigger_price"));
    }

    inline void to_json(json & j, const MfSips::Datum & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, MfSips::MfSips& x) {
        x.set_data(MfSips::get_optional<std::vector<MfSips::Datum>>(j, "data"));
    }

    inline void to_json(json & j, const MfSips::MfSips & x) {
        j = json::object();
        j["data"] = x.get_data();
    }
}
