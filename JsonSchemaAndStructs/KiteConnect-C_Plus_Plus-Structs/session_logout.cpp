...
namespace quicktype {
    ...
    class SessionLogoutClass {
        public:
        SessionLogoutClass() = default;
        virtual ~SessionLogoutClass() = default;
    ...
    class Definitions {
        ...
        private:
        SessionLogoutClass session_logout;

        public:
        const SessionLogoutClass & get_session_logout() const { return session_logout; }
        SessionLogoutClass & get_mutable_session_logout() { return session_logout; }
        void set_session_logout(const SessionLogoutClass & value) { this->session_logout = value; }
    };
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::SessionLogoutClass & x);
    void to_json(json & j, const quicktype::SessionLogoutClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::SessionLogout & x);
    void to_json(json & j, const quicktype::SessionLogout & x);
    ...
    inline void from_json(const json & j, quicktype::SessionLogoutClass& x) {
    ...
    inline void to_json(json & j, const quicktype::SessionLogoutClass & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        x.set_session_logout(j.at("SessionLogout").get<quicktype::SessionLogoutClass>());
    }

    inline void to_json(json & j, const quicktype::Definitions & x) {
        j = json::object();
        j["SessionLogout"] = x.get_session_logout();
    }

    inline void from_json(const json & j, quicktype::SessionLogout& x) {
    ...
    inline void to_json(json & j, const quicktype::SessionLogout & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
