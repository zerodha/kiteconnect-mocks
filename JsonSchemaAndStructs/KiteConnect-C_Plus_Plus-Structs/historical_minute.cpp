...
namespace nlohmann {
    void from_json(const json & j, HistoricalMinute::Data & x);
    void to_json(json & j, const HistoricalMinute::Data & x);

    void from_json(const json & j, HistoricalMinute::HistoricalMinute & x);
    void to_json(json & j, const HistoricalMinute::HistoricalMinute & x);

    void from_json(const json & j, boost::variant<double, std::string> & x);
    void to_json(json & j, const boost::variant<double, std::string> & x);

    inline void from_json(const json & j, HistoricalMinute::Data& x) {
        x.set_candles(HistoricalMinute::get_optional<std::vector<std::vector<HistoricalMinute::Candle>>>(j, "candles"));
    }

    inline void to_json(json & j, const HistoricalMinute::Data & x) {
        j = json::object();
        j["candles"] = x.get_candles();
    }

    inline void from_json(const json & j, HistoricalMinute::HistoricalMinute& x) {
        x.set_data(HistoricalMinute::get_optional<HistoricalMinute::Data>(j, "data"));
        x.set_status(HistoricalMinute::get_optional<std::string>(j, "status"));
    }

    inline void to_json(json & j, const HistoricalMinute::HistoricalMinute & x) {
        j = json::object();
        j["data"] = x.get_data();
