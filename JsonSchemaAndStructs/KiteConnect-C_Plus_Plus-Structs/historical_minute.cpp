...
//
//     HistoricalMinute data = nlohmann::json::parse(jsonString);
...
namespace quicktype {
    ...
    class HistoricalMinuteProperties {
        public:
        HistoricalMinuteProperties() = default;
        virtual ~HistoricalMinuteProperties() = default;
    ...
    class HistoricalMinuteClass {
        public:
        HistoricalMinuteClass() = default;
        virtual ~HistoricalMinuteClass() = default;
        ...
        const HistoricalMinuteProperties & get_properties() const { return properties; }
        HistoricalMinuteProperties & get_mutable_properties() { return properties; }
        void set_properties(const HistoricalMinuteProperties & value) { this->properties = value; }
    ...
    class Definitions {
        ...
        Candle candle;
        Data data;
        HistoricalMinuteClass historical_minute;
        ...
        const HistoricalMinuteClass & get_historical_minute() const { return historical_minute; }
        HistoricalMinuteClass & get_mutable_historical_minute() { return historical_minute; }
        void set_historical_minute(const HistoricalMinuteClass & value) { this->historical_minute = value; }
    };

    class HistoricalMinute {
        public:
        HistoricalMinute() = default;
        virtual ~HistoricalMinute() = default;
...
namespace nlohmann {
    ...
    void from_json(const json & j, quicktype::HistoricalMinuteProperties & x);
    void to_json(json & j, const quicktype::HistoricalMinuteProperties & x);

    void from_json(const json & j, quicktype::HistoricalMinuteClass & x);
    void to_json(json & j, const quicktype::HistoricalMinuteClass & x);

    void from_json(const json & j, quicktype::Definitions & x);
    void to_json(json & j, const quicktype::Definitions & x);

    void from_json(const json & j, quicktype::HistoricalMinute & x);
    void to_json(json & j, const quicktype::HistoricalMinute & x);
    ...
    inline void from_json(const json & j, quicktype::HistoricalMinuteProperties& x) {
        x.set_data(j.at("data").get<quicktype::DataClass>());
        x.set_status(j.at("status").get<quicktype::AnyOf>());
    }

    inline void to_json(json & j, const quicktype::HistoricalMinuteProperties & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }

    inline void from_json(const json & j, quicktype::HistoricalMinuteClass& x) {
        x.set_additional_properties(j.at("additionalProperties").get<bool>());
        x.set_properties(j.at("properties").get<quicktype::HistoricalMinuteProperties>());
        x.set_required(j.at("required").get<std::vector<std::string>>());
        x.set_title(j.at("title").get<std::string>());
        x.set_type(j.at("type").get<std::string>());
    }

    inline void to_json(json & j, const quicktype::HistoricalMinuteClass & x) {
        j = json::object();
        j["additionalProperties"] = x.get_additional_properties();
        j["properties"] = x.get_properties();
        j["required"] = x.get_required();
    ...
    inline void from_json(const json & j, quicktype::Definitions& x) {
        ...
        x.set_historical_minute(j.at("HistoricalMinute").get<quicktype::HistoricalMinuteClass>());
    }
    ...
    inline void to_json(json & j, const quicktype::Definitions & x) {
        ...
        j["Data"] = x.get_data();
        j["HistoricalMinute"] = x.get_historical_minute();
    }

    inline void from_json(const json & j, quicktype::HistoricalMinute& x) {
        x.set_ref(j.at("$ref").get<std::string>());
        x.set_schema(j.at("$schema").get<std::string>());
        x.set_definitions(j.at("definitions").get<quicktype::Definitions>());
    }

    inline void to_json(json & j, const quicktype::HistoricalMinute & x) {
        j = json::object();
        j["$ref"] = x.get_ref();
