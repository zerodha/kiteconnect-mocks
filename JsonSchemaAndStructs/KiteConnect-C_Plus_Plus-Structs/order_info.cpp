...
namespace nlohmann {
    void from_json(const json & j, OrderInfo::Datum & x);
    void to_json(json & j, const OrderInfo::Datum & x);

    void from_json(const json & j, OrderInfo::OrderInfo & x);
    void to_json(json & j, const OrderInfo::OrderInfo & x);

    inline void from_json(const json & j, OrderInfo::Datum& x) {
        x.set_average_price(OrderInfo::get_optional<int64_t>(j, "average_price"));
        x.set_cancelled_quantity(OrderInfo::get_optional<int64_t>(j, "cancelled_quantity"));
        x.set_disclosed_quantity(OrderInfo::get_optional<int64_t>(j, "disclosed_quantity"));
        x.set_exchange(OrderInfo::get_optional<std::string>(j, "exchange"));
        x.set_exchange_order_id(OrderInfo::get_optional<std::string>(j, "exchange_order_id"));
        x.set_exchange_timestamp(OrderInfo::get_optional<std::string>(j, "exchange_timestamp"));
        x.set_filled_quantity(OrderInfo::get_optional<int64_t>(j, "filled_quantity"));
        x.set_instrument_token(OrderInfo::get_optional<int64_t>(j, "instrument_token"));
        x.set_order_id(OrderInfo::get_optional<std::string>(j, "order_id"));
        x.set_order_timestamp(OrderInfo::get_optional<std::string>(j, "order_timestamp"));
        x.set_order_type(OrderInfo::get_optional<std::string>(j, "order_type"));
        x.set_parent_order_id(OrderInfo::get_untyped(j, "parent_order_id"));
        x.set_pending_quantity(OrderInfo::get_optional<int64_t>(j, "pending_quantity"));
        x.set_placed_by(OrderInfo::get_optional<std::string>(j, "placed_by"));
        x.set_price(OrderInfo::get_optional<double>(j, "price"));
        x.set_product(OrderInfo::get_optional<std::string>(j, "product"));
        x.set_quantity(OrderInfo::get_optional<int64_t>(j, "quantity"));
        x.set_status(OrderInfo::get_optional<std::string>(j, "status"));
        x.set_status_message(OrderInfo::get_untyped(j, "status_message"));
        x.set_tag(OrderInfo::get_untyped(j, "tag"));
        x.set_tradingsymbol(OrderInfo::get_optional<std::string>(j, "tradingsymbol"));
        x.set_transaction_type(OrderInfo::get_optional<std::string>(j, "transaction_type"));
        x.set_trigger_price(OrderInfo::get_optional<int64_t>(j, "trigger_price"));
        x.set_validity(OrderInfo::get_optional<std::string>(j, "validity"));
        x.set_variety(OrderInfo::get_optional<std::string>(j, "variety"));
    }

    inline void to_json(json & j, const OrderInfo::Datum & x) {
        j = json::object();
    ...
    inline void from_json(const json & j, OrderInfo::OrderInfo& x) {
        x.set_data(OrderInfo::get_optional<std::vector<OrderInfo::Datum>>(j, "data"));
        x.set_status(OrderInfo::get_optional<std::string>(j, "status"));
    }

    inline void to_json(json & j, const OrderInfo::OrderInfo & x) {
        j = json::object();
        j["data"] = x.get_data();
        j["status"] = x.get_status();
    }
