...
class Definitions
  ...
  @[JSON::Field(key: "MFOrderResponse")]
  property mf_order_response : MfOrderResponseClass
end
...
class MfOrderResponseClass
  ...
  property properties : MfOrderResponseProperties
  ...
  @[JSON::Field(key: "type")]
  property mf_order_response_class_type : String
end
