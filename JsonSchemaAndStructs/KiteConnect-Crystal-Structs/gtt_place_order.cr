...
class Definitions
  ...
  @[JSON::Field(key: "GttPlaceOrder")]
  property gtt_place_order : GttPlaceOrderClass
end
...
class GttPlaceOrderClass
  ...
  property properties : GttPlaceOrderProperties
  ...
  @[JSON::Field(key: "type")]
  property gtt_place_order_class_type : String
end
