...
#
#   historical_oi = HistoricalOi.from_json! "{…}"
#   puts historical_oi.definitions.historical_oi.required.first
#
...
class HistoricalOiProperties < Dry::Struct
...
class HistoricalOiClass < Dry::Struct
  attribute :additional_properties,    Types::Bool
  attribute :properties,               HistoricalOiProperties
  attribute :required,                 Types.Array(Types::String)
  attribute :title,                    Types::String
  attribute :historical_oi_class_type, Types::String

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      additional_properties:    d.fetch("additionalProperties"),
      properties:               HistoricalOiProperties.from_dynamic!(d.fetch("properties")),
      required:                 d.fetch("required"),
      title:                    d.fetch("title"),
      historical_oi_class_type: d.fetch("type"),
    )
  end
...
class Definitions < Dry::Struct
  ...
  attribute :historical_oi, HistoricalOiClass
  ...
  def self.from_dynamic!(d)
    ...
    new(
      ...
      historical_oi: HistoricalOiClass.from_dynamic!(d.fetch("HistoricalOi")),
    )
  end
  ...
  def to_dynamic
    {
      ...
      "Data"         => @data.to_dynamic,
      "HistoricalOi" => @historical_oi.to_dynamic,
    }
  end
