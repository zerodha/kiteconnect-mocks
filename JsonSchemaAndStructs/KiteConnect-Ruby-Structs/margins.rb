...
#
#   margins = Margins.from_json! "{…}"
#   puts margins.definitions.margins.required.first
#
...
class DataProperties < Dry::Struct
  attribute :commodity, Commodity
  attribute :equity,    Commodity

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      commodity: Commodity.from_dynamic!(d.fetch("commodity")),
      equity:    Commodity.from_dynamic!(d.fetch("equity")),
    )
  end
  ...
  def to_dynamic
    {
      "commodity" => @commodity.to_dynamic,
      "equity"    => @equity.to_dynamic,
    }
  end
...
class ItyProperties < Dry::Struct
  attribute :available, Commodity
  ...
  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      available: Commodity.from_dynamic!(d.fetch("available")),
...
class Ity < Dry::Struct
  attribute :additional_properties, Types::Bool
  attribute :properties,            ItyProperties
  attribute :required,              Types.Array(Types::String)
  attribute :title,                 Types::String
  attribute :ity_type,              Types::String

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      additional_properties: d.fetch("additionalProperties"),
      properties:            ItyProperties.from_dynamic!(d.fetch("properties")),
      required:              d.fetch("required"),
      title:                 d.fetch("title"),
      ity_type:              d.fetch("type"),
    )
  end
...
class MarginsProperties < Dry::Struct
  attribute :data,   Commodity
  attribute :status, AdhocMargin

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      data:   Commodity.from_dynamic!(d.fetch("data")),
...
class MarginsClass < Dry::Struct
  attribute :additional_properties, Types::Bool
  attribute :properties,            MarginsProperties
  attribute :required,              Types.Array(Types::String)
  attribute :title,                 Types::String
  attribute :margins_class_type,    Types::String

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      additional_properties: d.fetch("additionalProperties"),
      properties:            MarginsProperties.from_dynamic!(d.fetch("properties")),
      required:              d.fetch("required"),
      title:                 d.fetch("title"),
      margins_class_type:    d.fetch("type"),
    )
  end
...
class Definitions < Dry::Struct
  ...
  attribute :ity,       Ity
  attribute :margins,   MarginsClass
  ...
  def self.from_dynamic!(d)
    ...
    new(
      ...
      ity:       Ity.from_dynamic!(d.fetch("Ity")),
      margins:   MarginsClass.from_dynamic!(d.fetch("Margins")),
    )
  end
