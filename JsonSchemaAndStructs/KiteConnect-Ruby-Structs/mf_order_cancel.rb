...
#
#   mf_order_cancel = MFOrderCancel.from_json! "{…}"
#   puts mf_order_cancel.definitions.mf_order_cancel.required.first
#
...
class MFOrderCancelProperties < Dry::Struct
...
class MFOrderCancelClass < Dry::Struct
  attribute :additional_properties,      Types::Bool
  attribute :properties,                 MFOrderCancelProperties
  attribute :required,                   Types.Array(Types::String)
  attribute :title,                      Types::String
  attribute :mf_order_cancel_class_type, Types::String

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      additional_properties:      d.fetch("additionalProperties"),
      properties:                 MFOrderCancelProperties.from_dynamic!(d.fetch("properties")),
      required:                   d.fetch("required"),
      title:                      d.fetch("title"),
      mf_order_cancel_class_type: d.fetch("type"),
    )
  end
  ...
  def to_dynamic
    {
      ...
      "required"             => @required,
      "title"                => @title,
      "type"                 => @mf_order_cancel_class_type,
    }
  end
...
class Definitions < Dry::Struct
  ...
  attribute :mf_order_cancel, MFOrderCancelClass

  def self.from_dynamic!(d)
    d = Types::Hash[d]
    new(
      data:            DataClass.from_dynamic!(d.fetch("Data")),
      mf_order_cancel: MFOrderCancelClass.from_dynamic!(d.fetch("MFOrderCancel")),
    )
  end
  ...
  def to_dynamic
    {
      "Data"          => @data.to_dynamic,
      "MFOrderCancel" => @mf_order_cancel.to_dynamic,
    }
  end
...
class MFOrderCancel < Dry::Struct
  attribute :ref,         Types::String
