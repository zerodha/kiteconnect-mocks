...
#
#     result = margins_equity_from_dict(json.loads(json_string))
...
class MarginsEquityProperties:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MarginsEquityProperties':
        assert isinstance(obj, dict)
        data = AvailableClass.from_dict(obj.get("data"))
        status = AdhocMargin.from_dict(obj.get("status"))
        return MarginsEquityProperties(data, status)
...
class MarginsEquityClass:
    ...
    def __init__(self, additional_properties: bool, properties: MarginsEquityProperties, required: List[str], title: str, type: str) -> None:
        self.additional_properties = additional_properties
        self.properties = properties
        self.required = required
        self.title = title
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MarginsEquityClass':
        assert isinstance(obj, dict)
        additional_properties = from_bool(obj.get("additionalProperties"))
        properties = MarginsEquityProperties.from_dict(obj.get("properties"))
        required = from_list(from_str, obj.get("required"))
        title = from_str(obj.get("title"))
        type = from_str(obj.get("type"))
        return MarginsEquityClass(additional_properties, properties, required, title, type)

    def to_dict(self) -> dict:
        result: dict = {}
        result["additionalProperties"] = from_bool(self.additional_properties)
        result["properties"] = to_class(MarginsEquityProperties, self.properties)
        result["required"] = from_list(from_str, self.required)
        result["title"] = from_str(self.title)
        result["type"] = from_str(self.type)
        return result
...
class Definitions:
    ...
    def __init__(self, available: Available, data: Data, margins_equity: MarginsEquityClass) -> None:
        self.available = available
        self.data = data
        self.margins_equity = margins_equity
    ...
    def from_dict(obj: Any) -> 'Definitions':
        ...
        margins_equity = MarginsEquityClass.from_dict(obj.get("MarginsEquity"))
        return Definitions(available, data, margins_equity)

    def to_dict(self) -> dict:
        result: dict = {}
        result["Available"] = to_class(Available, self.available)
        result["Data"] = to_class(Data, self.data)
        result["MarginsEquity"] = to_class(MarginsEquityClass, self.margins_equity)
        return result
...
class MarginsEquity:
    ...
    @staticmethod
    def from_dict(obj: Any) -> 'MarginsEquity':
        assert isinstance(obj, dict)
        ref = from_str(obj.get("$ref"))
        schema = from_str(obj.get("$schema"))
        definitions = Definitions.from_dict(obj.get("definitions"))
        return MarginsEquity(ref, schema, definitions)
...
def margins_equity_from_dict(s: Any) -> MarginsEquity:
    return MarginsEquity.from_dict(s)


def margins_equity_to_dict(x: MarginsEquity) -> Any:
    return to_class(MarginsEquity, x)
