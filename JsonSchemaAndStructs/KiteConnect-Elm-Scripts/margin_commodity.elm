...
--     import MarginCommodity exposing (marginCommodity)
--
-- and you're off to the races with
--
--     decodeString marginCommodity myJsonString

module MarginCommodity exposing
    ( MarginCommodity
    , marginCommodityToString
    , marginCommodity
    , Data
    , Available
    )
...
marginCommodityToString : MarginCommodity -> String
marginCommodityToString r = Jenc.encode 0 (encodeMarginCommodity r)

marginCommodity : Jdec.Decoder MarginCommodity
marginCommodity =
    Jpipe.decode MarginCommodity
        |> Jpipe.optional "data" (Jdec.nullable data) Nothing
        |> Jpipe.optional "status" (Jdec.nullable Jdec.string) Nothing

encodeMarginCommodity : MarginCommodity -> Jenc.Value
encodeMarginCommodity x =
    Jenc.object
