...
--     import OrderResponse exposing (orderResponse)
--
-- and you're off to the races with
--
--     decodeString orderResponse myJsonString

module OrderResponse exposing
    ( OrderResponse
    , orderResponseToString
    , orderResponse
    , Data
    )
...
orderResponseToString : OrderResponse -> String
orderResponseToString r = Jenc.encode 0 (encodeOrderResponse r)

orderResponse : Jdec.Decoder OrderResponse
orderResponse =
    Jpipe.decode OrderResponse
        |> Jpipe.optional "data" (Jdec.nullable data) Nothing
        |> Jpipe.optional "status" (Jdec.nullable Jdec.string) Nothing

encodeOrderResponse : OrderResponse -> Jenc.Value
encodeOrderResponse x =
    Jenc.object
