...
--     import OrderTrades exposing (orderTrades)
--
-- and you're off to the races with
--
--     decodeString orderTrades myJsonString

module OrderTrades exposing
    ( OrderTrades
    , orderTradesToString
    , orderTrades
    , Datum
...
orderTradesToString : OrderTrades -> String
orderTradesToString r = Jenc.encode 0 (encodeOrderTrades r)

orderTrades : Jdec.Decoder OrderTrades
orderTrades =
    Jpipe.decode OrderTrades
        |> Jpipe.optional "data" (Jdec.nullable (Jdec.array datum)) Nothing
        |> Jpipe.optional "status" (Jdec.nullable Jdec.string) Nothing

encodeOrderTrades : OrderTrades -> Jenc.Value
encodeOrderTrades x =
    Jenc.object
