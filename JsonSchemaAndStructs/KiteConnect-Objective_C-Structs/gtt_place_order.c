...
@interface QTGttPlaceOrder (JSONConversion)
...
@interface QTGttPlaceOrderClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTGttPlaceOrderProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTGttPlaceOrder *_Nullable QTGttPlaceOrderFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTGttPlaceOrder fromJSONDictionary:json];
...
QTGttPlaceOrder *_Nullable QTGttPlaceOrderFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTGttPlaceOrderFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTGttPlaceOrderToData(QTGttPlaceOrder *gttPlaceOrder, NSError **error)
{
    @try {
        id json = [gttPlaceOrder JSONDictionary];
...
NSString *_Nullable QTGttPlaceOrderToJSON(QTGttPlaceOrder *gttPlaceOrder, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTGttPlaceOrderToData(gttPlaceOrder, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTGttPlaceOrder
...
{
    return QTGttPlaceOrderFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTGttPlaceOrderFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttPlaceOrder alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTGttPlaceOrder.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttPlaceOrder.properties.allValues] mutableCopy];

    for (id jsonName in QTGttPlaceOrder.properties) {
        id propertyName = QTGttPlaceOrder.properties[jsonName];
...
{
    return QTGttPlaceOrderToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTGttPlaceOrderToJSON(self, encoding, error);
}
@end
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _gttPlaceOrder = [QTGttPlaceOrderClass fromJSONDictionary:(id)_gttPlaceOrder];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"GttPlaceOrder": [_gttPlaceOrder JSONDictionary],
    }];
...
@implementation QTGttPlaceOrderClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttPlaceOrderClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTGttPlaceOrderProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTGttPlaceOrderClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttPlaceOrderClass.properties.allValues] mutableCopy];

    for (id jsonName in QTGttPlaceOrderClass.properties) {
        id propertyName = QTGttPlaceOrderClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTGttPlaceOrderProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttPlaceOrderProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTGttPlaceOrderProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttPlaceOrderProperties.properties.allValues] mutableCopy];
