...
@interface QTOrderModify (JSONConversion)
...
@interface QTOrderModifyClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTOrderModifyProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTOrderModify *_Nullable QTOrderModifyFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTOrderModify fromJSONDictionary:json];
...
QTOrderModify *_Nullable QTOrderModifyFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTOrderModifyFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTOrderModifyToData(QTOrderModify *orderModify, NSError **error)
{
    @try {
        id json = [orderModify JSONDictionary];
...
NSString *_Nullable QTOrderModifyToJSON(QTOrderModify *orderModify, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTOrderModifyToData(orderModify, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTOrderModify
...
{
    return QTOrderModifyFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTOrderModifyFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTOrderModify alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTOrderModify.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTOrderModify.properties.allValues] mutableCopy];

    for (id jsonName in QTOrderModify.properties) {
        id propertyName = QTOrderModify.properties[jsonName];
...
{
    return QTOrderModifyToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTOrderModifyToJSON(self, encoding, error);
}
@end
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _orderModify = [QTOrderModifyClass fromJSONDictionary:(id)_orderModify];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"OrderModify": [_orderModify JSONDictionary],
    }];
...
@implementation QTOrderModifyClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTOrderModifyClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTOrderModifyProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTOrderModifyClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTOrderModifyClass.properties.allValues] mutableCopy];

    for (id jsonName in QTOrderModifyClass.properties) {
        id propertyName = QTOrderModifyClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTOrderModifyProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTOrderModifyProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTOrderModifyProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTOrderModifyProperties.properties.allValues] mutableCopy];
