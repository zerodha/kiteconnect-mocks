...
//
//   NSError *error;
//   QTGttDeleteOrder *gttDeleteOrder = [QTGttDeleteOrder fromJSON:json encoding:NSUTF8Encoding error:&error];

#import <Foundation/Foundation.h>

@class QTGttDeleteOrder;
@class QTDefinitions;
@class QTData;
@class QTDataProperties;
@class QTTriggerID;
@class QTGttDeleteOrderClass;
@class QTGttDeleteOrderProperties;
@class QTDataClass;
...
@interface QTGttDeleteOrder : NSObject
...
@property (nonatomic, strong) QTGttDeleteOrderClass *gttDeleteOrder;
@end
...
@interface QTGttDeleteOrderClass : NSObject
@property (nonatomic, assign) BOOL isAdditionalProperties;
@property (nonatomic, strong) QTGttDeleteOrderProperties *properties;
@property (nonatomic, copy)   NSArray<NSString *> *required;
@property (nonatomic, copy)   NSString *title;
@property (nonatomic, copy)   NSString *type;
@end

@interface QTGttDeleteOrderProperties : NSObject
