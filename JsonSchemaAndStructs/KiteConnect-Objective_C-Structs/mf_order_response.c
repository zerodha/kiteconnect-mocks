...
@interface QTMFOrderResponse (JSONConversion)
...
@interface QTMFOrderResponseClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTMFOrderResponseProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTMFOrderResponse *_Nullable QTMFOrderResponseFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTMFOrderResponse fromJSONDictionary:json];
...
QTMFOrderResponse *_Nullable QTMFOrderResponseFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTMFOrderResponseFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTMFOrderResponseToData(QTMFOrderResponse *mFOrderResponse, NSError **error)
{
    @try {
...
NSString *_Nullable QTMFOrderResponseToJSON(QTMFOrderResponse *mFOrderResponse, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTMFOrderResponseToData(mFOrderResponse, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTMFOrderResponse
...
{
    return QTMFOrderResponseFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFOrderResponseFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrderResponse alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTMFOrderResponse.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrderResponse.properties.allValues] mutableCopy];

    for (id jsonName in QTMFOrderResponse.properties) {
        id propertyName = QTMFOrderResponse.properties[jsonName];
...
{
    return QTMFOrderResponseToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFOrderResponseToJSON(self, encoding, error);
}
@end
...
+ (NSDictionary<NSString *, NSString *> *)properties
{
    ...
    return properties = properties ? properties : @{
        @"Data": @"data",
        @"MFOrderResponse": @"mfOrderResponse",
    };
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _mfOrderResponse = [QTMFOrderResponseClass fromJSONDictionary:(id)_mfOrderResponse];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"MFOrderResponse": [_mfOrderResponse JSONDictionary],
    }];
...
@implementation QTMFOrderResponseClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrderResponseClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTMFOrderResponseProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFOrderResponseClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrderResponseClass.properties.allValues] mutableCopy];

    for (id jsonName in QTMFOrderResponseClass.properties) {
        id propertyName = QTMFOrderResponseClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTMFOrderResponseProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrderResponseProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFOrderResponseProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrderResponseProperties.properties.allValues] mutableCopy];
