...
@interface QTGttGetOrder (JSONConversion)
...
@interface QTGttGetOrderClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTGttGetOrderProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
@interface QTResultClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTGttGetOrder *_Nullable QTGttGetOrderFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTGttGetOrder fromJSONDictionary:json];
...
QTGttGetOrder *_Nullable QTGttGetOrderFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTGttGetOrderFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTGttGetOrderToData(QTGttGetOrder *gttGetOrder, NSError **error)
{
    @try {
        id json = [gttGetOrder JSONDictionary];
...
NSString *_Nullable QTGttGetOrderToJSON(QTGttGetOrder *gttGetOrder, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTGttGetOrderToData(gttGetOrder, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTGttGetOrder
...
{
    return QTGttGetOrderFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTGttGetOrderFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttGetOrder alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTGttGetOrder.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttGetOrder.properties.allValues] mutableCopy];

    for (id jsonName in QTGttGetOrder.properties) {
        id propertyName = QTGttGetOrder.properties[jsonName];
...
{
    return QTGttGetOrderToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTGttGetOrderToJSON(self, encoding, error);
}
@end
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _gttGetOrder = [QTGttGetOrderClass fromJSONDictionary:(id)_gttGetOrder];
        _order = [QTOrder fromJSONDictionary:(id)_order];
        _orderResult = [QTOrderResult fromJSONDictionary:(id)_orderResult];
        _result = [QTResultClass fromJSONDictionary:(id)_result];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"GttGetOrder": [_gttGetOrder JSONDictionary],
...
@implementation QTGttGetOrderClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttGetOrderClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTGttGetOrderProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTGttGetOrderClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttGetOrderClass.properties.allValues] mutableCopy];

    for (id jsonName in QTGttGetOrderClass.properties) {
        id propertyName = QTGttGetOrderClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTGttGetOrderProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTGttGetOrderProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _data = [QTConditionClass fromJSONDictionary:(id)_data];
        _status = [QTExchange fromJSONDictionary:(id)_status];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTGttGetOrderProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTGttGetOrderProperties.properties.allValues] mutableCopy];
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTResultClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTResultClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTResultClass.properties.allValues] mutableCopy];

    for (id jsonName in QTResultClass.properties) {
        id propertyName = QTResultClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
