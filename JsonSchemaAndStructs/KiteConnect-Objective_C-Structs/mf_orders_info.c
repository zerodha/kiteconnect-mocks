...
@interface QTMFOrdersInfo (JSONConversion)
...
@interface QTMFOrdersInfoClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTMFOrdersInfoProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTMFOrdersInfo *_Nullable QTMFOrdersInfoFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTMFOrdersInfo fromJSONDictionary:json];
...
QTMFOrdersInfo *_Nullable QTMFOrdersInfoFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTMFOrdersInfoFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTMFOrdersInfoToData(QTMFOrdersInfo *mFOrdersInfo, NSError **error)
{
    @try {
...
NSString *_Nullable QTMFOrdersInfoToJSON(QTMFOrdersInfo *mFOrdersInfo, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTMFOrdersInfoToData(mFOrdersInfo, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTMFOrdersInfo
...
{
    return QTMFOrdersInfoFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFOrdersInfoFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrdersInfo alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTMFOrdersInfo.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrdersInfo.properties.allValues] mutableCopy];

    for (id jsonName in QTMFOrdersInfo.properties) {
        id propertyName = QTMFOrdersInfo.properties[jsonName];
...
{
    return QTMFOrdersInfoToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFOrdersInfoToJSON(self, encoding, error);
}
@end
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _mfOrdersInfo = [QTMFOrdersInfoClass fromJSONDictionary:(id)_mfOrdersInfo];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"MFOrdersInfo": [_mfOrdersInfo JSONDictionary],
    }];
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _exchangeOrderID = [QTAmount fromJSONDictionary:(id)_exchangeOrderID];
        _exchangeTimestamp = [QTAmount fromJSONDictionary:(id)_exchangeTimestamp];
...
@implementation QTMFOrdersInfoClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrdersInfoClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTMFOrdersInfoProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFOrdersInfoClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrdersInfoClass.properties.allValues] mutableCopy];

    for (id jsonName in QTMFOrdersInfoClass.properties) {
        id propertyName = QTMFOrdersInfoClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTMFOrdersInfoProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFOrdersInfoProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFOrdersInfoProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFOrdersInfoProperties.properties.allValues] mutableCopy];
