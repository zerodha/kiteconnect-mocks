...
//
//   NSError *error;
//   QTOrderTrades *orderTrades = [QTOrderTrades fromJSON:json encoding:NSUTF8Encoding error:&error];
...
@class QTOrderTradesClass;
@class QTOrderTradesProperties;
@class QTData;
@class QTItems;
...
@interface QTOrderTrades : NSObject
...
@property (nonatomic, strong) QTOrderTradesClass *orderTrades;
@end
...
@interface QTOrderTradesClass : NSObject
@property (nonatomic, assign) BOOL isAdditionalProperties;
@property (nonatomic, strong) QTOrderTradesProperties *properties;
@property (nonatomic, copy)   NSArray<NSString *> *required;
@property (nonatomic, copy)   NSString *title;
@property (nonatomic, copy)   NSString *type;
@end

@interface QTOrderTradesProperties : NSObject
