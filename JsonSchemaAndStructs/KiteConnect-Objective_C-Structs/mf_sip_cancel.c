...
@interface QTMFSIPCancel (JSONConversion)
...
@interface QTMFSIPCancelClass (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end

@interface QTMFSIPCancelProperties (JSONConversion)
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict;
- (NSDictionary *)JSONDictionary;
@end
...
QTMFSIPCancel *_Nullable QTMFSIPCancelFromData(NSData *data, NSError **error)
{
    @try {
        id json = [NSJSONSerialization JSONObjectWithData:data options:NSJSONReadingAllowFragments error:error];
        return *error ? nil : [QTMFSIPCancel fromJSONDictionary:json];
...
QTMFSIPCancel *_Nullable QTMFSIPCancelFromJSON(NSString *json, NSStringEncoding encoding, NSError **error)
{
    return QTMFSIPCancelFromData([json dataUsingEncoding:encoding], error);
}

NSData *_Nullable QTMFSIPCancelToData(QTMFSIPCancel *mFSIPCancel, NSError **error)
{
    @try {
...
NSString *_Nullable QTMFSIPCancelToJSON(QTMFSIPCancel *mFSIPCancel, NSStringEncoding encoding, NSError **error)
{
    NSData *data = QTMFSIPCancelToData(mFSIPCancel, error);
    return data ? [[NSString alloc] initWithData:data encoding:encoding] : nil;
}

@implementation QTMFSIPCancel
...
{
    return QTMFSIPCancelFromData(data, error);
}

+ (_Nullable instancetype)fromJSON:(NSString *)json encoding:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFSIPCancelFromJSON(json, encoding, error);
}

+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFSIPCancel alloc] initWithJSONDictionary:dict] : nil;
}
...
{
    id resolved = QTMFSIPCancel.properties[key];
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFSIPCancel.properties.allValues] mutableCopy];

    for (id jsonName in QTMFSIPCancel.properties) {
        id propertyName = QTMFSIPCancel.properties[jsonName];
...
{
    return QTMFSIPCancelToData(self, error);
}

- (NSString *_Nullable)toJSON:(NSStringEncoding)encoding error:(NSError *_Nullable *)error
{
    return QTMFSIPCancelToJSON(self, encoding, error);
}
@end
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        ...
        _mfsipCancel = [QTMFSIPCancelClass fromJSONDictionary:(id)_mfsipCancel];
    }
    return self;
}
...
- (NSDictionary *)JSONDictionary
{
    ...
    [dict addEntriesFromDictionary:@{
        ...
        @"MFSIPCancel": [_mfsipCancel JSONDictionary],
    }];
...
@implementation QTMFSIPCancelClass
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFSIPCancelClass alloc] initWithJSONDictionary:dict] : nil;
}
...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    if (self = [super init]) {
        [self setValuesForKeysWithDictionary:dict];
        _properties = [QTMFSIPCancelProperties fromJSONDictionary:(id)_properties];
    }
    return self;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFSIPCancelClass.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFSIPCancelClass.properties.allValues] mutableCopy];

    for (id jsonName in QTMFSIPCancelClass.properties) {
        id propertyName = QTMFSIPCancelClass.properties[jsonName];
        if (![jsonName isEqualToString:propertyName]) {
            dict[jsonName] = dict[propertyName];
            [dict removeObjectForKey:propertyName];
        }
...
@implementation QTMFSIPCancelProperties
+ (NSDictionary<NSString *, NSString *> *)properties
{
    static NSDictionary<NSString *, NSString *> *properties;
    return properties = properties ? properties : @{
...
+ (instancetype)fromJSONDictionary:(NSDictionary *)dict
{
    return dict ? [[QTMFSIPCancelProperties alloc] initWithJSONDictionary:dict] : nil;
}
...
- (void)setValue:(nullable id)value forKey:(NSString *)key
{
    id resolved = QTMFSIPCancelProperties.properties[key];
    if (resolved) [super setValue:value forKey:resolved];
}
...
- (NSDictionary *)JSONDictionary
{
    id dict = [[self dictionaryWithValuesForKeys:QTMFSIPCancelProperties.properties.allValues] mutableCopy];
