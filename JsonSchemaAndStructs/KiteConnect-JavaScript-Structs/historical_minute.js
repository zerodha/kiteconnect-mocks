...
function toHistoricalMinute(json) {
    return cast(JSON.parse(json), r("HistoricalMinute"));
}

function historicalMinuteToJson(value) {
...
module.exports = {
    "historicalMinuteToJson": historicalMinuteToJson,
    "toHistoricalMinute": toHistoricalMinute,
};
