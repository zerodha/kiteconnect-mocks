...
function toOrderTrades(json) {
    return cast(JSON.parse(json), r("OrderTrades"));
}

function orderTradesToJson(value) {
...
module.exports = {
    "orderTradesToJson": orderTradesToJson,
    "toOrderTrades": toOrderTrades,
};
