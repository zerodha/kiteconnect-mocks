...
function toGttGetOrders(json) {
    return cast(JSON.parse(json), r("GttGetOrders"));
}

function gttGetOrdersToJson(value) {
...
const typeMap = {
    ...
    "Datum": o([
        ...
        { json: "meta", js: "meta", typ: u(undefined, u(r("Meta"), null)) },
...
module.exports = {
    "gttGetOrdersToJson": gttGetOrdersToJson,
    "toGttGetOrders": toGttGetOrders,
};
