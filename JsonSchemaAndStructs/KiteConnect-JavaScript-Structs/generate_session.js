...
function toGenerateSession(json) {
    return cast(JSON.parse(json), r("GenerateSession"));
}

function generateSessionToJson(value) {
...
const typeMap = {
    ...
    "Data": o([
        ...
        { json: "login_time", js: "login_time", typ: u(undefined, Date) },
        ...
        { json: "public_token", js: "public_token", typ: u(undefined, "") },
...
module.exports = {
    "generateSessionToJson": generateSessionToJson,
    "toGenerateSession": toGenerateSession,
};
