...
namespace MarginsEquity
{
    ...
    public partial class MarginsEquity
    {
        public static MarginsEquity FromJson(string json) => JsonConvert.DeserializeObject<MarginsEquity>(json, MarginsEquity.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this MarginsEquity self) => JsonConvert.SerializeObject(self, MarginsEquity.Converter.Settings);
    }
