...
namespace OrderTrades
{
    ...
    public partial class OrderTrades
    {
        public static OrderTrades FromJson(string json) => JsonConvert.DeserializeObject<OrderTrades>(json, OrderTrades.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this OrderTrades self) => JsonConvert.SerializeObject(self, OrderTrades.Converter.Settings);
    }
