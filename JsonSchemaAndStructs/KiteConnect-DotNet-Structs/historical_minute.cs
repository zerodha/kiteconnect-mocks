...
namespace HistoricalMinute
{
    ...
    public partial class HistoricalMinute
    {
        public static HistoricalMinute FromJson(string json) => JsonConvert.DeserializeObject<HistoricalMinute>(json, HistoricalMinute.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this HistoricalMinute self) => JsonConvert.SerializeObject(self, HistoricalMinute.Converter.Settings);
    }
